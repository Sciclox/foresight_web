...
// Dimensiones base para diseño desktop (1920x1080)
const kDesktopBaseWidth = 1920.0;
const kDesktopBaseHeight = 1080.0;

// Función helper para escalar valores proporcionalmente basándose en 1920x1080
// Usa el ancho de pantalla como referencia principal para mantener proporciones
double scaleDesktop(double value, BuildContext context) {
  if (responsiveVisibility(context: context, phone: false, tablet: false, tabletLandscape: false, desktop: true)) {
    final screenWidth = MediaQuery.sizeOf(context).width;
    return value * (screenWidth / kDesktopBaseWidth);
  }
  return value; // En mobile/tablet, retornar el valor sin escalar
}

// Función helper específica para altura si es necesario
double scaleDesktopHeight(double value, BuildContext context) {
  if (responsiveVisibility(context: context, phone: false, tablet: false, tabletLandscape: false, desktop: true)) {
    final screenHeight = MediaQuery.sizeOf(context).height;
    return value * (screenHeight / kDesktopBaseHeight);
  }
  return value;
}

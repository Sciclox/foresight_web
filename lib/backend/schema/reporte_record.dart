...
class ReporteRecord extends FirestoreRecord {
  ...
  // "archivoDescargable" field.
  String? _archivoDescargable;
  String get archivoDescargable => _archivoDescargable ?? '';
  bool hasArchivoDescargable() => _archivoDescargable != null;
  ...
  void _initializeFields() {
    ...
    _archivoDescargable = snapshotData['archivoDescargable'] as String?;
...
Map<String, dynamic> createReporteRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'archivoDescargable': archivoDescargable,
...
class ReporteRecordDocumentEquality implements Equality<ReporteRecord> {
  ...
  bool equals(ReporteRecord? e1, ReporteRecord? e2) {
    return e1?.titulo == e2?.titulo &&
        ...
        e1?.archivoDescargable == e2?.archivoDescargable &&

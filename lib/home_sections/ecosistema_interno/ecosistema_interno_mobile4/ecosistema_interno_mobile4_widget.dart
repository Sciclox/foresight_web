...
import 'ecosistema_interno_mobile4_model.dart';
export 'ecosistema_interno_mobile4_model.dart';

class EcosistemaInternoMobile4Widget extends StatefulWidget {
  const EcosistemaInternoMobile4Widget({super.key});

  @override
  State<EcosistemaInternoMobile4Widget> createState() =>
      _EcosistemaInternoMobile4WidgetState();
}

class _EcosistemaInternoMobile4WidgetState
    extends State<EcosistemaInternoMobile4Widget>
    with TickerProviderStateMixin {
  late EcosistemaInternoMobile4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EcosistemaInternoMobile4Model());

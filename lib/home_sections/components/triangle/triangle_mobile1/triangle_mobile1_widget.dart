...
import 'triangle_mobile1_model.dart';
export 'triangle_mobile1_model.dart';

class TriangleMobile1Widget extends StatefulWidget {
  const TriangleMobile1Widget({super.key});

  @override
  State<TriangleMobile1Widget> createState() => _TriangleMobile1WidgetState();
}

class _TriangleMobile1WidgetState extends State<TriangleMobile1Widget> {
  late TriangleMobile1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TriangleMobile1Model());
        ...
        child: Padding(
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-0.65, -0.08),
                child: Transform.rotate(

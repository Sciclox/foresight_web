...
import 'triangle_mobile2_model.dart';
export 'triangle_mobile2_model.dart';

class TriangleMobile2Widget extends StatefulWidget {
  const TriangleMobile2Widget({super.key});

  @override
  State<TriangleMobile2Widget> createState() => _TriangleMobile2WidgetState();
}

class _TriangleMobile2WidgetState extends State<TriangleMobile2Widget> {
  late TriangleMobile2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TriangleMobile2Model());

    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Align(
            alignment: AlignmentDirectional(-0.88, -0.4),
            child: Container(
              decoration: BoxDecoration(
          ...
          Align(
            alignment: AlignmentDirectional(0.9, -0.18),
            child: Container(
              decoration: BoxDecoration(
                color: Color(0xB2FFFFFF),
                borderRadius: BorderRadius.circular(30.0),
          ...
          Align(
            alignment: AlignmentDirectional(-0.39, 0.56),
            child: Container(
              decoration: BoxDecoration(
                color: Color(0xB2FFFFFF),
                borderRadius: BorderRadius.circular(30.0),
          ...
          Align(
            alignment: AlignmentDirectional(0.51, 0.78),
            child: Container(
              decoration: BoxDecoration(
                color: Color(0xB2FFFFFF),
                borderRadius: BorderRadius.circular(30.0),

...
class _ReporteWidgetState extends State<ReporteWidget>
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF0F092C),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                              Color(0xFFD3CFE6),
                                                                          fontSize:
                                                                              MediaQuery.sizeOf(context).width * 0.04091,
                                                                          letterSpacing:
                                                                              0.0,
                                                                          fontWeight:
                                                                              FontWeight.w300,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: wrapWithModel(
                                          ...
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: IniciativasDesktopWidget(),
                                        ),
                                      ),
                                    ],
                                  ),

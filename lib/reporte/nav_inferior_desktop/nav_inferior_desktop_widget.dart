...
import 'nav_inferior_desktop_model.dart';
export 'nav_inferior_desktop_model.dart';

class NavInferiorDesktopWidget extends StatefulWidget {
  const NavInferiorDesktopWidget({
    super.key,
    bool? parameter1,
    bool? parameter2,
    bool? parameter3,
  ...
  @override
  State<NavInferiorDesktopWidget> createState() =>
      _NavInferiorDesktopWidgetState();
}

class _NavInferiorDesktopWidgetState extends State<NavInferiorDesktopWidget> {
  late NavInferiorDesktopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavInferiorDesktopModel());
